...
UPDATE `drone` SET `image` = '/uploads/mavic3pro_drone.png' WHERE `model` = 'DJI Mavic 3 Pro';
UPDATE `drone` SET `image` = '/uploads/mini3pro_drone.png' WHERE `model` = 'DJI Mini 3 Pro';
UPDATE `drone` SET `image` = '/uploads/mini4pro_drone.png' WHERE `model` = 'DJI Mini 4 Pro';
UPDATE `drone` SET `image` = '/uploads/air2s_drone.png' WHERE `model` = 'DJI Air 2S';
UPDATE `drone` SET `image` = '/uploads/air2s_drone.png' WHERE `model` = 'DJI Air 3';
UPDATE `drone` SET `image` = '/uploads/inspire2_drone.png' WHERE `model` = 'DJI Inspire 2';
UPDATE `drone` SET `image` = '/uploads/inspire2_drone.png' WHERE `model` = 'DJI Matrice 300 RTK';
UPDATE `drone` SET `image` = '/uploads/inspire2_drone.png' WHERE `model` = 'DJI Avata 2';
UPDATE `drone` SET `image` = '/uploads/inspire2_drone.png' WHERE `model` = 'DJI FPV';
