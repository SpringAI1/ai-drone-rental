<template>
  <div class="order-page">
    ...
    <PageHeader title="待发货订单" subtitle="商家正在准备货物" />
        ...
        <div class="order-content" @click="goToDetail(order.id)">
          <div class="drone-info">
            ...
            <div class="drone-detail">
              ...
              <p class="delivery-address">收货地址：{{ order.deliveryAddress }}</p>
            </div>
          </div>
...
import { getMyOrders, applyRefund } from '@/api/order'
