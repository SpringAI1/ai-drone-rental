  ...
  <div class="profile-page">
    ...
    <div class="profile-content">
      ...
      <div class="profile-main">
        ...
        <!-- 账户余额 -->
        <GlassCard v-if="activeMenu === 'balance'" title="账户余额">
          <div class="balance-section">
            <div class="balance-overview">
              <div class="balance-amount">
                <span class="balance-label">账户余额</span>
                <span class="balance-value">¥{{ authStore.user?.balance || '0.00' }}</span>
              </div>
            ...
            <el-form-item label="充值金额" prop="amount">
              <div class="recharge-options">
                <el-button
                  ...
                  :key="option"
                  :type="rechargeForm.amount === option ? 'primary' : 'default'"
                  @click="rechargeForm.amount = option"
                >
                  ¥{{ option }}
                </el-button>
              </div>
...
import { User, CircleCheck, Lock, Select, Clock, CloseBold, Plus, Document, Medal, List, ChatDotRound, Wallet } from '@element-plus/icons-vue'
import { ElMessage } from 'element-plus'
import PageHeader from '@/components/common/PageHeader.vue'
import GlassCard from '@/components/common/GlassCard.vue'
import StatusTag from '@/components/common/StatusTag.vue'
import { useAuthStore } from '@/stores/auth'
import { updateUserInfo, updatePassword, submitQualification, uploadCertificate, getQualification, getMyOrders, recharge } from '@/api/user'
...
const menuItems = [
  ...
  { key: 'balance', label: '账户余额', icon: markRaw(Wallet) },
...
const verifyRules = {
  ...
  validStartDate: [
    { required: true, message: '请选择有效期开始日期', trigger: 'submit' }
  ],
  validEndDate: [
    { required: true, message: '请选择有效期结束日期', trigger: 'submit' }
  ]
}
