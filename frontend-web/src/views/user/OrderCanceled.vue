  ...
  <div class="order-page">
    <div class="breadcrumb-wrapper">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>已取消</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    
    <PageHeader title="已取消订单" subtitle="订单已取消" />
    ...
    <div v-loading="loading" class="order-list">
      ...
      >
        <div class="order-header">
          ...
          <StatusTag text="已取消" type="danger" />
        </div>
        ...
        <div class="order-content" @click="goToDetail(order.id)">
          <div class="drone-info">
            ...
            <div class="drone-detail">
              ...
              <p class="cancel-reason">取消原因：{{ order.cancelReason || '-' }}</p>
            </div>
          </div>
        ...
        <div class="order-footer">
          <div class="order-actions">
            <el-button type="primary" @click="goToDrone(order.droneId)">重新下单</el-button>
          </div>
        </div>
      </GlassCard>
