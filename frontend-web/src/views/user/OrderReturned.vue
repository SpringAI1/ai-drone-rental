  ...
  <div class="order-page">
    <div class="breadcrumb-wrapper">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>已归还</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    
    <PageHeader title="已归还订单" subtitle="感谢使用我们的服务" />
      ...
      >
        ...
        <div class="order-content" @click="goToDetail(order.id)">
          <div class="drone-info">
            ...
            <div class="drone-detail">
              ...
              <p class="return-time">归还时间：{{ formatDateTime(order.returnTime) }}</p>
            </div>
          </div>
        ...
        <div class="order-footer">
          <div class="order-actions">
            <el-button v-if="!order.hasComment" type="primary" @click="goToComment(order)">去评价</el-button>
            <el-button v-else>已评价</el-button>
          </div>
        </div>
      </GlassCard>
...
const goToComment = (order) => {
  router.push(`/drones/${order.droneId}`)
}
