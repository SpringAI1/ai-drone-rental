...
const rules = {
  nickname: [
    ...
    { min: 2, max: 20, message: '昵称长度为2-20个字符', trigger: 'submit' }
  ],
  username: [
    { required: true, message: '请输入用户名', trigger: 'submit' },
    { min: 3, max: 20, message: '用户名长度为3-20个字符', trigger: 'submit' }
  ],
  password: [
    { required: true, message: '请输入密码', trigger: 'submit' },
    { min: 6, message: '密码至少6位', trigger: 'submit' }
  ],
  confirmPassword: [
  ...
  agreement: [
    { validator: validateAgreement, trigger: 'submit' }
  ]
}
